 ...
 *************************************************************************/
// Usage:
//   g++ -I$MGC_HOME/shared/include ac_reciprocal_pwl_vha_lutgen.cpp -o ac_reciprocal_pwl_vha_lutgen
//   ./ac_reciprocal_pwl_vha_lutgen
// results in a text file ac_reciprocal_pwl_vha_lut_values.txt which can be pasted into
// a locally modified version of ac_reciprocal_pwl_vha.h.
...
int main()
{
  ...
  // as this .cpp file
  const char filename[] = "ac_reciprocal_pwl_vha_lut_values.txt";
