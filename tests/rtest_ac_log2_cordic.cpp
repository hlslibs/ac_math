...
int main(int argc, char *argv[])
{
  ...
  test_driver< 8, -2, 40, 12, true>(max_error_log2, allowed_error, threshold);
  test_driver<20, 12, 40, 12, true>(max_error_log2, allowed_error, threshold);
  test_driver<20,  0, 40, 12, true>(max_error_log2, allowed_error, threshold);
  test_driver<20,  1, 40, 12, true>(max_error_log2, allowed_error, threshold);
  test_driver<20,  2, 40, 12, true>(max_error_log2, allowed_error, threshold);
  test_driver<20,  3, 40, 12, true>(max_error_log2, allowed_error, threshold);
