...
int main(int argc, char *argv[])
{
  ...
  //template <int Wfi, int Ifi, int outWfi, int outIfi, bool outSfi>
  test_driver<16,  1, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  2, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  3, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  4, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  5, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  6, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  7, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  8, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver<16,  9, 40, 12, false>(max_error_log2, allowed_error, threshold);
  test_driver< 8, 12, 40, 12, false>(max_error_log2, allowed_error, threshold);
