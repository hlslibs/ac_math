...
int main(int argc, char *argv[])
{
  ...
  // template <int Wfi, int Ifi, bool Sfi, int outWfi, int outIfi>
  test_driver< 16, -4, false, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 12,  3,  true, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 20,  4,  true, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 16,  4,  true, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 20,  1,  true, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 12,  3, false, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 20,  4, false, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 16,  4, false, 40, 20>(max_error_exp, allowed_error, threshold);
  test_driver< 20,  0, false, 40, 20>(max_error_exp, allowed_error, threshold);
