...
// ac_softsign_pwl() function using a variety of bit-widths.

// To compile standalone and run:
//   $MGC_HOME/bin/c++ -std=c++11 -I$MGC_HOME/shared/include rtest_ac_softsign_pwl.cpp -o design
//   ./design
...
// ==============================================================================
// Test Designs
//   These simple function allow executing the ac_softsign_pwl() function.
...
//   piece-wise linear softsign model with the computed softsign using a
...
)
{
  ...
  cout << "TEST: ac_softsign_pwl() INPUT: ";
  cout.width(38);
  ...
  for (double i = lower_limit; i <= upper_limit; i += step) {
    ...
    input_fixed = i;
    test_ac_softsign_pwl_fixed(input_fixed, output);

    double expected_value = ((T_out)(input_fixed.to_double()/(1 + abs(input_fixed.to_double())))).to_double();
...
int main(int argc, char *argv[])
{
  ...
  cout << "=============================================================================" << endl;
  cout << "Testing function: ac_softsign_pwl() - Allowed error " << allowed_error << endl;
  ...
  if (test_fail) {
    cout << "  ac_softsign_pwl - FAILED - Error tolerance(s) exceeded" << endl; 
    cout << "=============================================================================" << endl;
    return -1; 
  } else {
    cout << "  ac_softsign_pwl - PASSED" << endl;
    cout << "=============================================================================" << endl;
  }  
  return (0);
}
