...
// ac_relu() function using a variety of bit-widths.

// To compile standalone and run:
//   $MGC_HOME/bin/c++ -std=c++11 -I$MGC_HOME/shared/include rtest_ac_relu.cpp -o design
//   ./design
...
// ==============================================================================
// Test Designs
//   This simple function allow executing the ac_relu() function.
...
//   piece-wise linear relu model with the computed relu using a
...
)
{
  ...
  for (double i = lower_limit; i <= upper_limit; i += step) {
    ...
    input_fixed = i;
    test_ac_relu_fixed(input_fixed, output);

    double expected_value = (input_fixed>0)?input_fixed.to_double():0;
...
int main(int argc, char *argv[])
{
  ...
  cout << "=============================================================================" << endl;
  cout << "Testing function: ac_relu() - Allowed error " << allowed_error << endl;
  ...
  if (test_fail) {
    cout << "  ac_relu - FAILED - Error tolerance(s) exceeded" << endl; 
    cout << "=============================================================================" << endl;
    return -1; 
  } else {
    cout << "  ac_relu - PASSED" << endl;
    cout << "=============================================================================" << endl;
  }  
  return (0);
}
