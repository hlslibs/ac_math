...
int main(int argc, char *argv[])
{
  ...
  test_driver_float<18,  2, 10, 32,  1, 15>(max_error_float, allowed_error);
  test_driver_float<18,  1, 10, 32,  1, 15>(max_error_float, allowed_error);
  test_driver_float<18,  0, 10, 32,  1, 15>(max_error_float, allowed_error);
  test_driver_float<18, -1, 10, 32,  1, 15>(max_error_float, allowed_error);
  test_driver_float<18, -2, 10, 32,  1, 15>(max_error_float, allowed_error);
  test_driver_float<18, 12, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18,  4, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18,  2, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18,  1, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18,  0, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18, -1, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18, -2, 10, 32,  6, 15>(max_error_float, allowed_error);
  test_driver_float<18, 12, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18,  4, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18,  2, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18,  1, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18,  0, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18, -1, 10, 32, -4, 15>(max_error_float, allowed_error);
  test_driver_float<18, -2, 10, 32, -4, 15>(max_error_float, allowed_error);
