...
// ac_elu_pwl() function using a variety of bit-widths.

// To compile standalone and run:
//   $MGC_HOME/bin/c++ -std=c++11 -I$MGC_HOME/shared/include rtest_ac_elu_pwl.cpp -o design
//   ./design
...
// ==============================================================================
// Test Designs
//   These simple function allow executing the ac_elu_pwl() function.
...
//   piece-wise linear elu model with the computed elu using a
...
)
{
  ...
  for (double i = lower_limit; i <= upper_limit; i += step) {
    ...
    input_fixed = i;
    test_ac_elu_pwl_fixed(input_fixed, output, alpha);

    double expected_value = (input_fixed >= 0) ? input_fixed.to_double() : ((T_out)(alpha.to_double() * (exp(input_fixed.to_double()) - 1.0))).to_double();
...
int main(int argc, char *argv[])
{
  ...
  cout << "=============================================================================" << endl;
  cout << "Testing function: ac_elu_pwl() - Allowed error " << allowed_error << endl;
  ...
  if (test_fail) {
    cout << "  ac_elu_pwl - FAILED - Error tolerance(s) exceeded" << endl; 
    cout << "=============================================================================" << endl;
    return -1; 
  } else {
    cout << "  ac_elu_pwl - PASSED" << endl;
    cout << "=============================================================================" << endl;
  }  
  return (0);
}
